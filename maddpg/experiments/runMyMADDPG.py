...
#------------ wolf ------------------------
    ...
    # getModelList = [lambda: trainMADDPGModels.getTrainedModels()[i] for i in range(numAgents)]
    modelSaveRate = 5000
    modelPath = os.path.join(dirName, '..', 'myMADDPGPolicy')
...
# trainMADDPGModels.getTrainedModels()[0].graph._nodes_by_name