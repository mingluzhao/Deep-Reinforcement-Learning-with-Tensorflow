...
def main():
    ...
    if debug:
        numWolves = 2
        costActionRatio = 0.0
        recoveredSelfishIndex = 10000.0
        continueSelfishIndex = 0.0
        fileID = 0.0
        ...
        recoveredSelfishIndex = float(condition['recoveredSelfishIndex'])
        continueSelfishIndex = float(condition['continueSelfishIndex'])
        fileID = float(condition['fileID'])
    ...
    fileName = "maddpg{}wolves{}sheep{}blocks{}episodes{}stepSheepSpeed{}WolfActCost{}sensitive{}biteReward{}killPercent{}file{}_agent".format(
        numWolves, numSheeps, numBlocks, maxEpisode, maxTimeStep, sheepSpeedMultiplier, costActionRatio, recoveredSelfishIndex, biteReward, killProportion, fileID)
    ...
    getAgentsPercentageOfRewards = GetAgentsPercentageOfRewards(continueSelfishIndex, collisionDist)
    terminalCheck = TerminalCheck()
    getCollisionWolfReward = GetCollisionWolfReward(biteReward, collisionReward, killProportion, sampleFromDistribution, terminalCheck)
    ...
    fileName = "maddpg{}wolves{}sheep{}blocks{}episodes{}stepSheepSpeed{}WolfActCost{}biteReward{}killPercent{}initSensitive{}later{}file{}_agent".format(
        numWolves, numSheeps, numBlocks, maxEpisode, maxTimeStep, sheepSpeedMultiplier, costActionRatio, biteReward, killProportion, recoveredSelfishIndex,continueSelfishIndex, fileID)
