...
#
#     resultLoc = os.path.join(resultPath, 'evalRewardWithKillProbAndDistSensitiveNoBiteRew.pkl')
...
#                     axForDraw.title.set_text('sheepSpeed' + str(keyCol* sheepMaxSpeedOriginal))
...
#     plt.suptitle('MADDPG Evaluate wolfSelfishness/ sheepSpeed/ actionCost')
#     plt.savefig(os.path.join(resultPath, 'evalRewardWithKillProbAndDistSensitiveNoBiteRew_biteNum'))
#     plt.show()
#     plt.close()
#
#     # ---
...
#     figure.text(x=0.03, y=0.5, s='Mean Episode Bite', ha='center', va='center', rotation=90)
#     plt.suptitle('MADDPG Evaluate wolfSelfishness/ sheepSpeed/ actionCost')
#     plt.savefig(os.path.join(resultPath, 'evalRewardWithKillProbAndDistSensitiveNoBiteRew_biteNum_regroup'))
#     plt.show()
#     plt.close()
#
#     # --------
...
#     plt.suptitle('MADDPG Evaluate wolfSelfishness/ sheepSpeed/ actionCost')
#     plt.savefig(os.path.join(resultPath, 'evalRewardWithKillProbAndDistSensitiveNoBiteRew_MoveDistance'))
#     plt.show()
...
def main():
    ...
    resultLoc2 = os.path.join(resultPath, 'evalRewardWithKillProbAndDistSensitiveNoBiteRew2wolves.pkl')
    resultDF2 = loadFromPickle(resultLoc2)

    resultLoc34 = os.path.join(resultPath, 'evalRewardWithKillProbAndDistSensitiveNoBiteRew34.pkl')
    resultDF34 = loadFromPickle(resultLoc34)

    resultLoc56 = os.path.join(resultPath, 'evalRewardWithKillProbAndDistSensitiveNoBiteRew6wolves.pkl')
    resultDF56 = loadFromPickle(resultLoc56)

    resultDF = resultDF2.combine_first(resultDF34)
    resultDF = resultDF.combine_first(resultDF56)
