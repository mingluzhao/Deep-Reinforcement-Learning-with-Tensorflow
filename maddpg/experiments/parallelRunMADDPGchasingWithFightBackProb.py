...
def main():
    ...
    conditionLevels = [(wolfNum, sheepNum, blockNum, timeStep, sheepSpeed, individReward, costRatio, initHurtProb)
                       ...
                       for initHurtProb in initHurtProbList]

    conditions = []
    for condition in conditionLevels:
        numWolves, numSheeps, numBlocks, maxTimeStep, sheepSpeedMultiplier, individualRewardWolf, costActionRatio, initHurtProb = condition
        parameters = {'numWolves': numWolves, 'numSheeps': numSheeps, 'numBlocks': numBlocks,
                      ...
                      'individualRewardWolf': individualRewardWolf, 'costActionRatio': costActionRatio, 'initHurtProb': initHurtProb}
