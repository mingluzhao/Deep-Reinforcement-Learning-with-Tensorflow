...
def main():
    ...
    independentVariables['rewardSensitivityToDistance'] = [0.0, 10000.0]
    ...
    resultLoc = os.path.join(resultPath, 'evalRewardWithKillProbAndDistSensitiveNoBiteRew_noactcost.pkl')
    ...
    plt.savefig(os.path.join(resultPath, 'evalRewardWithKillProbAndDistSensitiveNoBiteRew_noactcost_biteNum'))
    plt.show()
    plt.close()
