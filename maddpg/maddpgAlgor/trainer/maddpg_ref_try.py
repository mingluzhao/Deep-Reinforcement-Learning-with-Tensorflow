...
def p_train(observPlaceHolderList, actionSpaceList, agentIndex, p_func, q_func, optimizer,
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        p = p_func(p_input, int(actionPlaceHolderTypeList[agentIndex].param_shape()[0]), scope="p_func", num_units=num_units)
        ...
        # p loss from resampled action of the same state
        ...
        # target network
        target_p = p_func(p_input, int(actionPlaceHolderTypeList[agentIndex].param_shape()[0]), scope="target_p_func", num_units=num_units)
