...
def main():
    ...
    with tf.device("/cpu:0"):
        ...
        for workerID in range(numWorkers):
            ...
            worker = A3CWorkerUsingGym(maxGlobalEpisode, coord, getValueTargetList, workerEnv, maxTimeStepPerEps, globalCount,
                                       globalReward, updateInterval, workerNet, saveModel, bootStrap)
