...
#     state_ = criticGraph.get_collection_ref("state_")[0]
#     action_ = criticGraph.get_collection_ref("action_")[0]
#     trainValues_ = criticGraph.get_collection_ref("trainValues_")[0]
#     trainValues = criticGraph.run(trainValues_, feed_dict={state_: stateBatch, action_: actionsBatch})
#     return trainValues
...
#     criticTrainParams_ = criticTargetGraph.get_collection_ref("criticTrainParams_")[0]
#     replaceParam_ = criticTargetGraph.get_collection_ref("replaceParam_")[0]
