...
def main():
    ...
    dirName = os.path.dirname(__file__)
    actorModelPath = os.path.join(dirName, '..', '..', 'trainedDDPGModels', 'noWolfAvoidBoundary', 'actorModel=0_dimension=2_gamma=0.95_learningRateActor=0.001_learningRateCritic=0.001_maxEpisode=1000_maxTimeStep=100_minibatchSize=32_wolfSpeed=0.ckpt')
    ...
    # reset = lambda: np.array([19.9, 10, 15, 5])
