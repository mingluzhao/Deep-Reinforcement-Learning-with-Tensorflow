...
def main():
    ...
    parameters = {'wolfSpeed': wolfSpeed, 'maxEpisode': maxEpisode, 'maxTimeStep': maxTimeStep, 'minibatchSize': minibatchSize,
                  'learningRate': learningRateActor, 'noiseInitVar': noiseInitVariance, 'decay': varianceDiscount,
