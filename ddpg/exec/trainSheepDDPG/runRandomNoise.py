...
from src.policy import ActDDPGOneStep, ActRandom, ActDDPGOneStepWithRandomNoise
...
# maxEpisode = 20
bufferSize = 1e8
noiseDecayStartStep = 100000
learningStartBufferSize = noiseDecayStartStep
...
def main():
    ...
    #
    actRandom = ActRandom(actionLow, actionHigh)
    actOneStepWithNoise = ActDDPGOneStepWithRandomNoise(actRandom, actByPolicyTrain, actorModel, noiseDecayStartStep)
    ...
    parameters = {'wolfSpeed': wolfSpeed, 'dimension': actionDim, 'maxEpisode': maxEpisode, 'maxTimeStep': maxTimeStep,
                  'minibatchSize': minibatchSize, 'gamma': gamma,
                  'learningRateActor': learningRateActor, 'learningRateCritic': learningRateCritic}

    modelSaveDirectory = "../../trainedDDPGModels/wolfAvoidBoundaryActionCost/randomNoise"
